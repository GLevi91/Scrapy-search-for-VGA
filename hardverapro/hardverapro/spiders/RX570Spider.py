...
class RX570Spider(CrawlSpider):
    name = "rx570"
    start_urls = ["http://hardverapro.hu/aprok/hardver/videokartya/pcie?kategoria_gyartokhoz=66&gyartokereses=-1&hirdetesVaros=-1&hirdetesTipusa=-1&GYORSKERESO_TOKEN=K5J2N58CKP77MB56MA8J&gyorskereses=rx+570&gyorskereses_hidden=Gyorskeres%C3%A9s+itt%3A+PCIe"]
